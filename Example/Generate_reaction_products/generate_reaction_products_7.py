...
template_1 = "[R][C@H]1[C@@H]([X])COC=C1"
template_2 = "[R][C@@H]1[C@H]([X])COC=C1"
template_3 = "[R][C@@H]1[C@@H]([X])COC=C1"
template_4 = "[R][C@H]1[C@H]([X])COC=C1"
template_5 = "[R][C@@H]1C[C@H]([X])OC=C1"
template_6 = "[R][C@H]1C[C@@H]([X])OC=C1"
template_7 = "[R][C@@H]1C[C@@H]([X])OC=C1"
template_8 = "[R][C@H]1C[C@H]([X])OC=C1"
...
for i in range(len(uniq_indices)):
    ...
    for j in top_indices:
        ...
        try:
            os.mkdir('Reaction7/'+str(i)+'/'+str(j))
        except:
            pass

        write('Reaction7/'+str(i)+'/'+str(j)+'/conf.xyz', conformer_tmp, format='xyz')

        f = open('Reaction7/'+str(i)+'/'+str(j)+'/isomer.txt','w')
