...
template_1 = "[R][C@H]1C=C[C@@H]([X])[C@@H]([R'])O1"
template_2 = "[R][C@H]1C=C[C@@H]([X])[C@H]([R'])O1"
template_3 = "[R][C@@H]1C=C[C@H]([X])[C@@H]([R'])O1"
template_4 = "[R][C@@H]1C=C[C@H]([X])[C@H]([R'])O1"
template_5 = "[R][C@H]1C=C[C@@H]([X])O[C@H]1[R']"
template_6 = "[R][C@H]1C=C[C@@H]([X])O[C@@H]1[R']"
template_7 = "[R][C@@H]1C=C[C@H]([X])O[C@H]1[R']"
template_8 = "[R][C@@H]1C=C[C@H]([X])O[C@@H]1[R']"
...
for i in range(len(uniq_indices)):
    ...
    for j in top_indices:
        ...
        try:
            os.mkdir('Reaction11/'+str(i)+'/'+str(j))
        except:
            pass

        write('Reaction11/'+str(i)+'/'+str(j)+'/conf.xyz', conformer_tmp, format='xyz')

        f = open('Reaction11/'+str(i)+'/'+str(j)+'/isomer.txt','w')
